...
#!/bin/sh
exec /app/bin/zypak-wrapper \
    "/app/bin/xranimator/XR Animator - electron-v33.2.0-linux-x64_SA/electron" \
    --ozone-platform-hint=auto \
    --no-sandbox \
    "/app/bin/xranimator/AT_SystemAnimator_v110330.gadget/index.html" \
    "$@"
